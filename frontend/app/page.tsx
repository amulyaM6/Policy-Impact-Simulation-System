    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 relative overflow-hidden bg-grid-cyber">
      ...
      <section className="relative pt-24 pb-20 px-6 lg:px-12 max-w-7xl mx-auto text-center z-10">
        ...
        <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-700 font-mono text-xs font-bold uppercase tracking-widest mb-8 shadow-sm shadow-indigo-100 animate-float">
          ...
          <span>HYBRID STOCHASTIC ENGINE: MULTI-AGENT (ABM) + MONTE CARLO</span>
        </div>
        ...
        <p className="text-slate-600 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
          ...
          <span className="text-indigo-600 font-mono font-bold underline decoration-pink-500 decoration-2 underline-offset-4"> 10,000 Monte Carlo trials</span> grounded in real RBI statistical baselines.
        </p>
      ...
      {/* ── 2. LIVE AGENT SHOCK TOPOLOGY GRAPH SECTION ── */}
      <section className="py-16 px-6 lg:px-12 max-w-7xl mx-auto z-10 relative">
        <div className="text-center mb-10">
          <span className="text-xs font-mono font-bold text-indigo-700 uppercase tracking-widest bg-indigo-50 px-4 py-1.5 rounded-full border border-indigo-200">
            INTERACTIVE AGENT SIMULATOR STAGE
          </span>
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mt-4 mb-3">
            Real-Time Agent Shock & Cascade Topology
          </h2>
          <p className="text-slate-600 max-w-2xl mx-auto font-sans">
            Click any shock button below to inject macro-economic disturbances directly into our agent-based graph network:
          </p>
        </div>
      ...
      {/* ── 3. HOLOGRAPHIC INTER-STATE POLICY CASCADE MAP ── */}
      <section className="py-16 px-6 lg:px-12 max-w-7xl mx-auto z-10 relative">
        <div className="text-center mb-10">
          <span className="text-xs font-mono font-bold text-purple-700 uppercase tracking-widest bg-purple-50 px-4 py-1.5 rounded-full border border-purple-200">
            SPATIAL IMPACT FORECASTING
          </span>
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mt-4 mb-3">
            Inter-State Policy Cascade & Spillover Matrix
          </h2>
        </div>
      ...
      {/* ── 4. MONTE CARLO PROBABILITY FAN CHART ── */}
      <section className="py-16 px-6 lg:px-12 max-w-7xl mx-auto z-10 relative">
        <MonteCarloFanChart />
      </section>

      {/* ── 5. LIVE DRAFT A vs DRAFT B LASER SPLIT COMPARATOR ── */}
      <section className="py-16 px-6 lg:px-12 max-w-7xl mx-auto z-10 relative">
        <SplitPolicySlider />
      </section>
        ...
        <div className="hud-panel rounded-3xl p-6 lg:p-10 border border-slate-200 relative overflow-hidden shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              {/* Stress-Test Interactive Slider */}
              <div className="p-5 rounded-2xl bg-slate-100/90 border border-slate-200 space-y-3 font-mono">
                <div className="flex justify-between items-center text-xs font-bold">
                  <span className="text-indigo-700 flex items-center gap-2">
                    ...
                    Stochastic Market Volatility Factor:
                  </span>
                  <span className="text-pink-600 text-sm font-black">{volatilityFactor}%</span>
                </div>
                <input
                  type="range"
                  min="0"
                ...
                <p className="text-[10px] text-slate-500 italic">
                  Drag slider to introduce simulated macro shocks (monsoon variance, inflation rates).
                </p>
              </div>
